<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <footer class="footer item">
     <div class="footer_info">
         <div class="inner_wrap">
             <div class="footer_nav">
                 ...
                 <a href="travel?page=0" style="text-decoration: none !important"><li style="color:#868697">여행 계획</li></a>
     ...
     <div class="footer_info">
         ...
         <a href="https://github.com/devwithpug/TIME-TO-TRAVEL" target="_blank">201714042 최준규</a>
     </div>
 </footer>