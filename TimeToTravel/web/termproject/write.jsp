                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <form method="post" action="/write?page=<%=currentPage%>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>제목</label>
                                            <input type="text" class="form-control" placeholder="제목" name="title" minlength="5" maxlength="100" value="<%=route.getTitle()%>" required="required">
                                        </div>
                                        <c:choose>
                                        ...
                                        <div class="form-group">
                                            <label>여행지</label>
                                            <input type="text" class="form-control" placeholder="ex) 국내여행, 뉴욕, 동유럽" value="<%=route.getDestination()%>" name="destination" minlength="1" maxlength="50" required="required">
                                        </div>
                                        <div class="form-group">
                                            <label>총 여행일</label>
                                        ...
                                        <div class="form-group">
                                            <label>총 인원 (명)</label>
                                            <input type="number" class="form-control" value="<%=route.getPerson()%>" placeholder="ex) 4 (명)" name="person" min="1" max="100" required="required">
                                        </div>
                                        <div class="form-group">
                                            <label>여행 주제</label>
                                        ...
                                        <div class="form-group">
                                            <label>내용</label>
                                            <textarea type="text" class="form-control" rows="5" name="description" placeholder="내용" minlength="5" maxlength="2048" required="required"><%=route.getDescription()%></textarea>
                                        </div>
                                        <br><br>
                                        <button type="submit" class="btn btn-primary">등록</button>
                                        <a class="btn btn-secondary" onclick="cancel('<%=currentPage%>', '<%=route.getPostId()%>')">취소</a>
                                    </form>
                                </c:otherwise>
                            </c:choose>
                        </div>
